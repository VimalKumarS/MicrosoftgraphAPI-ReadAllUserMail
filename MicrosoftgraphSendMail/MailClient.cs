...
namespace Microsoft_Graph_Mail_Console_App
{
    public static class MailClient
    {
        ...
        {
            get { return "tesla329.onmicrosoft.com"; }
        }
        ...
        {
            get { return "9d78bab6-3ccc-4294-ae6c-4f02bba0901e"; }  //application ID
        }

        public static string ClientSecret
        {
            get { return "jxg2Y5p7W7lpZfJiT/PARTKSbgy9nRYzrcGOBIXKqB0="; }  //application ID
        }

        // The redirect URI specified in the Azure AD application
        public static Uri RedirectUri
        {
            get { return new Uri("http://localhost:1234/callback"); }
        }
        ...
        public static string GetAccessToken()
        {
            ...
            ClientCredential uc = null;
            string hardcodedUsername = "warpbubble@tesla329.onmicrosoft.com";
            string hardcodedPassword = "p@ssw0rd";
            uc = new ClientCredential(ClientId, ClientSecret);
            var uc1 = new UserPasswordCredential(hardcodedUsername, hardcodedPassword);
            ...
            var authenticationResult = authenticationContext.AcquireTokenAsync(GraphResource, ClientId, uc1).Result;
        ...
        public static async void GetUsersDemoAsync(string accessToken)
        {
        ...
        //public static async Task SendEmailDemoAsync(string fromEmailAddress, EmailMessage message)
        //{
